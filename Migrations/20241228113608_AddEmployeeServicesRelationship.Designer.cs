...
namespace BarberAppointmentSystem.Migrations
{
    ...
    [Migration("20241228113608_AddEmployeeServicesRelationship")]
    partial class AddEmployeeServicesRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeServices", b =>
                {
            ...
            modelBuilder.Entity("EmployeeServices", b =>
                {
                    b.HasOne("BarberAppointmentSystem.Models.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeesEmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BarberAppointmentSystem.Models.Services", null)
                        .WithMany()
